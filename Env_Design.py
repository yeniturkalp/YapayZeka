...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.surface((20,20)) # oyuncunun büyüklüğü
    ...
    def update(self,action):
        ...
        if self.rect.right > WIDTH: #ekrandan çıkartmamak 
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.Surface((10,10)) #düşman boyutu
        self.image.fill(RED)
        self.rect = self.image.get_rect()
        self.radius = 5 
        pygame.draw.circle(self.image,WHITE,self.rect.center,self.radius)
        self.rect.x = random.randrange(0, WIDTH - self.rect.widht)
        self.rect.y = random.randrange(2,6) # ekranda enemynin oluşacağı alan
        self.speedx = 0
        self.speedy = 3
...
class Env(pygame.sprite.Sprite):
    ...
    def run(self):
        ...
        while running:
            self.reward = 2
            # loopun doğru hızda çalışması için
            clock.tick(FPS)
            # süreç girişi / process input
            ...
            self.total.reward += self.rreward
            ...
            if hits:
                ...
                self.done = True
                running = False #true ile aynı amaç için kullanılıyor 
...
if __name__ == "__init__":
    ...
    while True:
        ...
        # initialize pygame and create window/ oyun ekranını oluşturma 
        pygame.init()
